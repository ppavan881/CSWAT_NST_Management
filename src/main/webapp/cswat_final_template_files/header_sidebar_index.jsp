...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a  class="w3-bar-item w3-button w3-padding" href="${pageContext.request.contextPath}/SiteController?page=login"  class="w3-bar-item w3-button w3-padding">&nbsp; Login User</a>
  	<a  class="w3-bar-item w3-button w3-padding" href="${pageContext.request.contextPath}/OperationController?page=request_access"  class="w3-bar-item w3-button w3-padding">&nbsp; Request Access</a>
