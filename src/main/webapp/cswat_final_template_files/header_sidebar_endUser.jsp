...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${pageContext.request.contextPath}/SiteController?page=Request_Support"  class="w3-bar-item w3-button w3-padding"  >&nbsp; Request Support</a>
    <a href="" class="w3-bar-item w3-button w3-padding">&nbsp; Log Out</a>
    <a href= "" class="w3-bar-item w3-button w3-padding">&nbsp; View Defect</a>
